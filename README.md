...
└── movie-studios-viability-project/                     
    ...
    ├── data_analys.ipynb                                       <- Documentation of Exploratory Data Analysis in Jupyter notebook
    ...
    ├── microsoft_analysis_notebook.pdf                         <- PDF version of Full Analysis shown in Jupyter notebook
